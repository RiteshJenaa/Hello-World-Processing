...
void setup() 
{
  ...
  String secondSentence = "Ritesh Jena counts to 10, by 1."; //Local Variables
  ...
  println(d, e, f, g, ten+y, h, str(two)+z); //Casting, making an INTEGER into a STRING
...
void draw() 
{
  ...
  println(d, e, f, g, ten+y, h, str(two)+z);
  two-=skipCount; // ten-1, ten--, ten-=1
  println(d, e, f, g, m+ten+y, h, str(two)+z);
  two*=skipCount; //+=, -=, *=, /=
  println(d, e, f, g, ten+y, h, str(two)+z);
  twenty/=skipCount; // Formula to count backwards from 10000 // //+=, -=, *=, /=
  println(d, e, f, g, one+y, "backwards from", str(twenty)+z);
  thirty/=skipCount; // Formula to count backwards from 10000 //ten-1, ten--, ten-=1
  println(d, e, f, g, one+y, "backwards from", str(thirty)+z);
